    ...
    <main className="relative w-full bg-alabaster">
      ...
      <section className="relative z-10 min-h-screen w-full flex items-center justify-center bg-alabaster border-b border-clay/10 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.03] select-none">
          <span className="text-[30vw] font-instrument leading-none text-charcoal tracking-tighter">ANTI</span>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-32 items-center">
            <div className="relative aspect-[4/5] md:aspect-[3/4] w-full overflow-hidden bg-stone/10 group order-2 md:order-1">
              ...
              <div className="absolute bottom-8 left-8 z-20 bg-alabaster/90 px-4 py-1.5 backdrop-blur-sm">
                <span className="text-[10px] uppercase tracking-[0.2em] font-geist text-charcoal font-medium">Est. 2025</span>
              </div>
            </div>
...
We are a people’s agency — for the people, with the people, and built to create pathways for the next generation of African talent.

At its core, Naath exists to ensure our people are not only seen globally, but supported, empowered, and developed with intention.
...
Every model on our roster is not simply a booking; they are a collaboration. We work hand-in-hand to develop their unique aesthetic, refine their craft, and strategically position them in markets that will honour their individuality, longevity, and potential.”`}</p>
          ...
          <div className="grid md:grid-cols-12 gap-12 lg:gap-24 items-start">
            ...
            <div className="md:col-span-7 md:pl-8 pt-0 md:pt-12 order-1 md:order-2">
              ...
              <div className="space-y-6 font-geist text-base md:text-lg leading-[1.7] text-charcoal/80 font-light">
                ...
                <p>{`After years of working internationally, she officially launched Naath with a long-term vision: to build sustainable infrastructure for African talent while creating safer, more strategic pathways into the global fashion industry.`}</p>
            ...
            <div className="space-y-24 md:space-y-32 relative z-10">
              <div className="flex flex-col md:flex-row items-start md:items-center w-full group">
                <div className="w-full md:w-1/2 md:pr-16 md:text-right order-2 md:order-1 pl-12 md:pl-0">
                  <h3 className="font-instrument text-3xl md:text-4xl mb-4 text-charcoal group-hover:text-stone transition-colors">Discovery</h3>
                  <p className="font-geist text-stone text-sm leading-relaxed max-w-sm ml-auto">Finding the unique. We scout for faces that tell stories, not just fill frames. We look for the anomaly.</p>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pl-16 order-3 md:order-3 pt-2 md:pt-0 pl-12">
                  <span className="font-geist text-[10px] uppercase tracking-widest text-clay font-medium">01</span>
                </div>
              </div>

              <div className="flex flex-col md:flex-row items-start md:items-center w-full group">
                <div className="w-full md:w-1/2 md:pr-16 md:text-right order-2 md:order-1 pl-12 md:pl-0 pt-2 md:pt-0">
                  <span className="font-geist text-[10px] uppercase tracking-widest text-clay font-medium">02</span>
                </div>

                <div className="absolute left-[-5px] md:left-1/2 md:-translate-x-1/2 w-[11px] h-[11px] bg-alabaster border border-charcoal rounded-full z-20 order-1 md:order-2 transition-transform duration-500 group-hover:scale-150 group-hover:bg-charcoal"></div>

                <div className="w-full md:w-1/2 md:pl-16 order-3 md:order-3 pl-12 md:pl-0">
                  <h3 className="font-instrument text-3xl md:text-4xl mb-4 text-charcoal group-hover:text-stone transition-colors">Development</h3>
                  <p className="font-geist text-stone text-sm leading-relaxed max-w-sm mr-auto">Polishing the diamond. Walking, posing, portfolio curation. We build the foundation before the launch.</p>
                </div>
              </div>

              <div className="flex flex-col md:flex-row items-start md:items-center w-full group">
                <div className="w-full md:w-1/2 md:pr-16 md:text-right order-2 md:order-1 pl-12 md:pl-0">
                  <h3 className="font-instrument text-3xl md:text-4xl mb-4 text-charcoal group-hover:text-stone transition-colors">Placement</h3>
                  <p className="font-geist text-stone text-sm leading-relaxed max-w-sm ml-auto">Strategic introduction to the world&apos;s top markets. New York. Paris. Milan. We place our models where they will be seen.</p>
                </div>

                <div className="absolute left-[-5px] md:left-1/2 md:-translate-x-1/2 w-[11px] h-[11px] bg-alabaster border border-charcoal rounded-full z-20 order-1 md:order-2 transition-transform duration-500 group-hover:scale-150 group-hover:bg-charcoal"></div>

                <div className="w-full md:w-1/2 md:pl-16 order-3 md:order-3 pt-2 md:pt-0 pl-12">
                  <span className="font-geist text-[10px] uppercase tracking-widest text-clay font-medium">03</span>
                </div>
              </div>
      ...
      <section className="relative z-50 w-full flex flex-col items-center justify-center bg-bone border-t border-clay/20 py-40 px-6">
        <div className="text-center space-y-16">
          <h3 className="font-instrument text-4xl md:text-6xl text-charcoal max-w-2xl mx-auto leading-tight">
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              <div className="text-center">
                <p className="font-geist text-[9px] md:text-[10px] uppercase tracking-[0.2em] leading-relaxed text-charcoal">
