...
const modelData: Record<string, ModelData> = {
  ...
  'nyanhial-kueii': {
    ...
    images: [
      ...
      { src: '/assets/images/models/nyanhial-kueii/IMG_2058.webp', alt: 'Portfolio 9', type: 'detail' },
      { src: '/assets/images/models/nyanhial-kueii/IMG_0353.webp', alt: 'Portfolio 10', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/naya_-4.webp', alt: 'Portfolio 11', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/IMG_2066.webp', alt: 'Portfolio 12', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/B82D6A59-98D2-4B12-B262-439674AB0293.webp', alt: 'Portfolio 13', type: 'landscape' },
      { src: '/assets/images/models/nyanhial-kueii/IMG_2057.webp', alt: 'Portfolio 14', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/IMG_2056.webp', alt: 'Portfolio 15', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/cl1k0509.webp', alt: 'Portfolio 16', type: 'portrait' },
      { src: '/assets/images/models/nyanhial-kueii/IMG_2065.webp', alt: 'Portfolio 17', type: 'portrait' },
    ],
    digitals: [
