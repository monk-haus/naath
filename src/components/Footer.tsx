      ...
      <div className="relative z-10 max-w-[1800px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-16 md:gap-0">
          ...
          <div className="w-full md:w-auto flex flex-col justify-start md:mb-2">
            <div className="mb-6">
              <span className="text-[10px] uppercase tracking-widest text-stone font-geist block mb-2">
                The Masterclass
              </span>
              <p
            ...
            <form onSubmit={handleSubscribe} className="relative max-w-xs w-full group">
              <input
                ...
                className="w-full bg-transparent border-b border-stone/30 py-3 text-alabaster text-sm placeholder:text-stone/50 focus:outline-none focus:border-alabaster transition-colors rounded-none font-geist tracking-wider uppercase"
              />
              <button
                type="submit"
                disabled={status === 'loading' || status === 'success'}
            ...
            {status === 'error' && (
              <span className="text-[10px] text-red-400 mt-2 font-geist tracking-wider uppercase">
          ...
          <div className="w-full md:w-auto flex flex-col items-center md:items-end gap-10 md:gap-8 text-center md:text-right">
            <div className="flex flex-col items-center md:items-end group">
              <span
                className="text-[10px] uppercase tracking-widest text-stone mb-4 md:mb-2 opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 font-geist"
              >
                Inquiries
              </span>
              <a
        ...
        <div className="mt-20 md:mt-32 w-full flex flex-col md:flex-row justify-between items-center border-t border-white/5 pt-8 gap-6 md:gap-0">
          ...
          <div className="flex gap-6 md:gap-8 order-2 md:order-1">
            <Link
              href="/privacy-policy"
              className="text-stone hover:text-alabaster transition-colors uppercase tracking-widest text-[9px] font-geist"
            >
              Privacy Policy
            </Link>
            <Link
